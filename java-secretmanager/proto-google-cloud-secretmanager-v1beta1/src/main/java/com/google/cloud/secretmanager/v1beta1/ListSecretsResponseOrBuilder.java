...
public interface ListSecretsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.secrets.v1beta1.ListSecretsResponse)
   ...
   * <code>repeated .google.cloud.secrets.v1beta1.Secret secrets = 1;</code>
   */
  com.google.cloud.secretmanager.v1beta1.SecretOrBuilder getSecretsOrBuilder(int index);
